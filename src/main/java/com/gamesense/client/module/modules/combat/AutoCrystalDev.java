...
/*
TODO BY CYBER:
1. Attempt to make improve placement calculations and have them be faster.
2. the reeeeeeeeeeeeeeesttttttttttttttttt


 */


public class AutoCrystalDev extends Module {
    public AutoCrystalDev() {
        super("AutoCrystalDev", Category.Combat);
    }
    ...
    public void setup() {
        ...
        espR = this.registerI("Red", 200, 0, 255);
        espG = this.registerI("Green", 50, 0, 255);
        espB = this.registerI("Blue", 200, 0, 255);
        espA = this.registerI("Alpha", 50, 0, 255);
    ...
    public void onWorldRender (RenderEvent event){
        if (this.render != null) {
            ...
            if (rainbow.getValue()) {
                ...
                GameSenseTessellator.drawBox(this.render, r, g, b, espA.getValue(), 63);
                GameSenseTessellator.release();
                GameSenseTessellator.prepare(7);
                GameSenseTessellator.drawBoundingBoxBlockPos(this.render, 1.00f, r, g, b, 255);
            } else {
                GameSenseTessellator.prepare(7);
                GameSenseTessellator.drawBox(this.render, espR.getValue(), espG.getValue(), espB.getValue(), espA.getValue(), 63);
                GameSenseTessellator.release();
                GameSenseTessellator.prepare(7);
                GameSenseTessellator.drawBoundingBoxBlockPos(this.render, 1.00f, espR.getValue(), espG.getValue(), espB.getValue(), 255);
            }
            GameSenseTessellator.release();
        }
