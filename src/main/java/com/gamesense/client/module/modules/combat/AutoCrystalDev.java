...
public class AutoCrystalDev extends Module {
    ...
    public void onUpdate() {
        ...
        while (true) {
                ...
                do {
                    if (!var9.hasNext()) {
                        ...
                        if (this.place.getValue()) {
                            ...
                            // Tick Place Delay, kinda stupid but a lot of people want it for a few servers with way
                            // too aggro anti-cheats.
            ...
            } while (((EntityLivingBase) entity).getHealth() <= 0.0F /* || mc.player.getDistanceSq(entity) > enemyRange.getValue() * enemyRange.getValue() */);
