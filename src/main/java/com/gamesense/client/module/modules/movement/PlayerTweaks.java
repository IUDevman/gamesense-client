...
public class PlayerTweaks extends Module {
    ...
    public void setup(){
        guiMove = this.registerB("Gui Move", false);
        noPush = this.registerB("No Push", false);
        noSlow = this.registerB("No Slow", false);
        antiKnockBack = this.registerB("Velocity", false);
    }
